...
if (isset($_POST["submit"])) {
    ...
    if (editGiveLoan($_POST) > 0) {
        echo "

      <script>
        alert('Paid off give loan successfully');
    ...
    ";
      ...
      <script>
        alert('Paid off give loan failed');
      </script>
        ...
        <div class="container">
            <div class="row d-flex justify-content-center">
                <div class=" col-xl-6 mt-5 mb-5">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="card-title">Detail Give Loan</h3>
                                    ...
                                    <?php if ($loan["status_loan"] != "Paid Off") : ?>
                                        <div class="col-12 mb-3">
                                            <div class="d-grid gap-2">
                                                <button class="btn btn-success" type="submit" name="submit" onclick=" return confirm ('Are you sure?');">Paid Off</button>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="d-grid gap-2">
                                                <button class="btn btn-light text-success" type="submit" name="delete" onclick=" return confirm ('Are you sure?');">Delete</button>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="d-grid gap-2">
                                                <?php $tgl = date_create($loan['due_date_loan']); ?>
                                                <a target="_blank" href="https://api.whatsapp.com/send?phone=<?= $loan["tel_loan"]; ?>&text=Hello%20<?= $loan["name_loan"]; ?>,%20you%20have%20a%20loan%20bill%20to%20me%20of%20IDR%20<?= number_format($loan['amount_loan'], 2, ',', '.'); ?>%20with%20a%20deadline%20of%20<?= date_format($tgl, 'd F Y') ?>.%20Please%20pay%20it%20off%20immediately." class="btn btn-outline-success" type="submit" name="Share">Share</a>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                    <div class="col mt-3">
                                        <div class="d-grid gap-2">
                                            <a href="loan.php" class="btn btn-light">Back</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
