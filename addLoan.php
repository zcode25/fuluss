...
if (isset($_POST["submit"])) {
    ...
    if (addGiveLoan($_POST) > 0) {
        echo "

      <script>
        alert('Add give loan successfully');
        ...
        <div class="container">
            <div class="row d-flex justify-content-center">
                <div class=" col-xl-6 mt-5 mb-5">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="card-title">Add Give Loan</h3>
                            <form class="mt-3" action="" method="post">
                                ...
                                <input class="form-control" type="hidden" id="category_loan" name="category_loan" value="Give" required>
